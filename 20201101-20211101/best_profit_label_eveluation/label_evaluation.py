...
BTC = yf.download('BTC-USD', start=datetime(2020, 11, 1), end=datetime(2021, 11, 1)) # start=datetime(2017, 11, 9), end=datetime(2018, 12, 31)
ETH = yf.download('ETH-USD',start=datetime(2020, 11, 1), end=datetime(2021, 11, 1))  #start=datetime(2018, 1, 1), end=datetime(2019, 9, 1)
# print(BTC.columns)
# print(ETH.columns)
...
a = 1.4341252646991598
b = 0.4609948464741439
k = 3
window1 = 1
window2 = 50
...
final_test_dataset=tests_for_lable.loc['2021-07-16':, ['rbtc_ret','reth_ret','z_score','z_score_singel_for_lable']]
final_label_path = "best_profit_machine_learning_for_lable_20201101_20211101.csv"
...
for i in range(0, len(final_test_dataset.index)):
    ...
    elif final_test_dataset.at[final_test_dataset.index[i], 'predict_final_label'] == 2:
        '''
        If the value of z_score touches the lower barrier, 
        indicating a negative deviation from the mean, 
        it means that the growth rate of ETH is too fast. 
    ...
    predict_port_outa_for_lable.append(predict_port_out_for_lable)
...
print("-------predict_predict_predict_predict_predict_predict_predict_predict_predict_predict_predict_predict_-----------------------")
...
print("-------Lableing---------Lableing----------------------FINALLY-------------Lableing------------------Lableing------------------------")
...
pt_out_pair_trading,_=get_pairstrategy_return()

pt_out_pair_trading=pt_out_pair_trading.loc['2021-07-16':]
