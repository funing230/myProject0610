...
BTC = yf.download('BTC-USD', start=datetime(2018, 1, 1), end=datetime(2019, 12, 31)) # start=datetime(2017, 11, 9), end=datetime(2018, 12, 31)
ETH = yf.download('ETH-USD',start=datetime(2018, 1, 1), end=datetime(2019, 12, 31))  #start=datetime(2018, 1, 1), end=datetime(2019, 9, 1)
# print(BTC.columns)
# print(ETH.columns)
...
# a = 1.507209423143998
# b = 0.32822827927643233
# k = 4
# window1 = 3
# window2 = 78

a = 1.7580696691737767
b = 0.15414188094094586
k = 4
window1 = 3
window2 = 61
...
tests_for_lable.insert(len(tests_for_lable.columns), 'Log_R', np.log(1 + pd.DataFrame(port_outa_z_score_singel_for_lable)))
tests_for_lable=tests_for_lable.dropna()
tests_for_lable.to_csv("tests_for_lable_dataset_20190101_20191231_best_profit.csv", index=True)
