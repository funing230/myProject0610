...
BTC = yf.download('BTC-USD', start=datetime(2021, 4, 1), end=datetime(2023, 4, 1))
ETH = yf.download('ETH-USD',start=datetime(2021, 4, 1), end=datetime(2023, 4, 1))
# print(BTC.columns)
# print(ETH.columns)
...
a =  1.5873969448848317
b = 0.5780371763135467
k = 3
window1 = 5
window2 = 25
...
tests_for_lable.insert(len(tests_for_lable.columns), 'Log_R', np.log(1 + pd.DataFrame(port_outa_z_score_singel_for_lable)))
tests_for_lable=tests_for_lable.dropna()
tests_for_lable.to_csv("tests_for_lable_dataset_20220401_20230401_best_profit.csv", index=True)
