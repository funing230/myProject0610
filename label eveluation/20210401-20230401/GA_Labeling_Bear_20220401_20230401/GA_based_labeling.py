...
BTC = yf.download('BTC-USD', start=datetime(2021, 4, 1), end=datetime(2023, 4, 1)) # start=datetime(2017, 11, 9), end=datetime(2018, 12, 31)
ETH = yf.download('ETH-USD',start=datetime(2021, 4, 1), end=datetime(2023, 4, 1))  #start=datetime(2018, 1, 1), end=datetime(2019, 9, 1)
...
sys.stdout = Logger("test0610_20210401_20230401.log", sys.stdout)
